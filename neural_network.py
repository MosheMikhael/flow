...
class yoloNetWork:
    def __init__(self, version='3'):
        ...
        if version == '2':
            self.v3_weights_adr = 'input/for yolo/yolov2.weights'
            self.v3_config_adr  = 'input/for yolo/yolov2.cfg'
        if version == '2tiny':
            self.v3_weights_adr = 'input/for yolo/yolov2-tiny.weights'
            self.v3_config_adr  = 'input/for yolo/yolov2-tiny.cfg'
...
def get_features(img, net = yoloNetWork('tiny')):
    scale = 0.00392
    Width = img.shape[1]
    Height = img.shape[0]
    more = 5
